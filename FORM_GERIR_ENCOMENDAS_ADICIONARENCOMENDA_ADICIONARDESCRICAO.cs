...
{
    public partial class FORM_GERIR_ENCOMENDAS_ADICIONARENCOMENDA_ADICIONARDESCRICAO : Form
    {
        ...
        public FORM_GERIR_ENCOMENDAS_ADICIONARENCOMENDA_ADICIONARDESCRICAO()
        {
            InitializeComponent();
            ...
            TEXTBOX_FormGestaoDeEncomendasAdicionarDescricao_ADICIONAR_DESCRICAO.Text = FormGerirEncomendas_Objects.AUX_Descricao;
        }

        private void _FormGestaoDeEncomendasAdicionarDescricao_BUTTON_FECHAR_Click(object sender, EventArgs e)
        {
            this.Close();
        }

        public void BUTTON_FormGestaoDeEncomendasAdicionarDescricao_GRAVAR_Click(object sender, EventArgs e)
        {
            if (REGEX_Texto_AdicionarDescricao() == true)
            {
                try
                {
                    FormGerirEncomendas_Objects.AUX_Descricao = TEXTBOX_FormGestaoDeEncomendasAdicionarDescricao_ADICIONAR_DESCRICAO.Text;
        ...
        private void TEXTBOX_FormGestaoDeEncomendasAdicionarDescricao_ADICIONAR_DESCRICAO_TextChanged(object sender, EventArgs e)
        {
            if (TEXTBOX_FormGestaoDeEncomendasAdicionarDescricao_ADICIONAR_DESCRICAO.Text != "")
                BUTTON_FormGestaoDeEncomendasAdicionarDescricao_GRAVAR.Enabled = true;
            
            if (TEXTBOX_FormGestaoDeEncomendasAdicionarDescricao_ADICIONAR_DESCRICAO.Text == "")
                BUTTON_FormGestaoDeEncomendasAdicionarDescricao_GRAVAR.Enabled = false;
        }

        private void TEXTBOX_FormGestaoDeEncomendasAdicionarDescricao_ADICIONAR_DESCRICAO_KeyPress(object sender, KeyPressEventArgs e)
        {
...
//       ║..:    REGULAR EXPRESSIONS    :..║
        ...
        public bool REGEX_Texto_AdicionarDescricao()
        {
            ...
            string AdicionarDescricao = TEXTBOX_FormGestaoDeEncomendasAdicionarDescricao_ADICIONAR_DESCRICAO.Text;

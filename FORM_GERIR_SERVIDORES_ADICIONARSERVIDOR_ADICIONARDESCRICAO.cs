...
{
    public partial class FORM_GERIR_SERVIDORES_ADICIONARSERVIDOR_ADICIONARDESCRICAO : Form
    {
        ...
        public FORM_GERIR_SERVIDORES_ADICIONARSERVIDOR_ADICIONARDESCRICAO()
        {
            InitializeComponent();
            ...
            TEXTBOX_FormGestaoServidoresAdicionarDescricao_ADICIONAR_DESCRICAO.Text = FormGerirServidores_Objects.AUX_Descricao;
        }

        private void MENUSTRIP_FormGestaoServidoresAdicionarDescricao_BUTTON_FECHAR_Click(object sender, EventArgs e)
        {
            this.Close();
        }

        private void BUTTON_FormGestaoServidoresAdicionarDescricao_GRAVAR_Click(object sender, EventArgs e)
        {
            if (REGEX_Texto_AdicionarDescricao() == true)
            {
                try
                {
                    FormGerirServidores_Objects.AUX_Descricao = TEXTBOX_FormGestaoServidoresAdicionarDescricao_ADICIONAR_DESCRICAO.Text;
        ...
        private void TEXTBOX_FormGestaoServidoresAdicionarDescricao_ADICIONAR_DESCRICAO_TextChanged(object sender, EventArgs e)
        {
            if (TEXTBOX_FormGestaoServidoresAdicionarDescricao_ADICIONAR_DESCRICAO.Text != "")
                BUTTON_FormGestaoServidoresAdicionarDescricao_GRAVAR.Enabled = true;

            if (TEXTBOX_FormGestaoServidoresAdicionarDescricao_ADICIONAR_DESCRICAO.Text == "")
                BUTTON_FormGestaoServidoresAdicionarDescricao_GRAVAR.Enabled = false;
        }
...
//       ║..:    REGULAR EXPRESSIONS    :..║
        ...
        public bool REGEX_Texto_AdicionarDescricao()
        {
            ...
            string AdicionarDescricao = TEXTBOX_FormGestaoServidoresAdicionarDescricao_ADICIONAR_DESCRICAO.Text;
        ...
        private void TEXTBOX_FormGestaoServidoresAdicionarDescricao_ADICIONAR_DESCRICAO_KeyPress(object sender, KeyPressEventArgs e)
        {

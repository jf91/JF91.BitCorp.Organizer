...
{
    public partial class FORM_GERIR_SERVIDORES_ALTERARSERVIDOR_ALTERARNOTA_ : Form
    {
        ...
        public FORM_GERIR_SERVIDORES_ALTERARSERVIDOR_ALTERARNOTA_()
        {
            InitializeComponent();
            ...
            TEXTBOX_FormGestaoServidoresAlterarNota_ALTERAR_NOTA.Text = FormGerirServidores_Objects.AUX_Nota;
        }

        private void MENUSTRIP_FormGestaoServidoresAlterarNota_BUTTON_FECHAR_Click(object sender, EventArgs e)
        {
            this.Close();
        }

        private void BUTTON_FormGestaoServidoresAlterarNota_GRAVAR_Click(object sender, EventArgs e)
        {
            if (REGEX_Texto_AlterarNota() == true)
            {
                try
                {
                    FormGerirServidores_Objects.AUX_Nota = TEXTBOX_FormGestaoServidoresAlterarNota_ALTERAR_NOTA.Text;
        ...
        private void TEXTBOX_FormGestaoServidoresAlterarNota_ALTERAR_NOTA_TextChanged(object sender, EventArgs e)
        {
            if (TEXTBOX_FormGestaoServidoresAlterarNota_ALTERAR_NOTA.Text != "")
                BUTTON_FormGestaoServidoresAlterarNota_GRAVAR.Enabled = true;

            if (TEXTBOX_FormGestaoServidoresAlterarNota_ALTERAR_NOTA.Text == "")
                BUTTON_FormGestaoServidoresAlterarNota_GRAVAR.Enabled = false;
        }
...
//       ║..:    REGULAR EXPRESSIONS    :..║
        ...
        public bool REGEX_Texto_AlterarNota()
        {
            ...
            string AdicionarDescricao = TEXTBOX_FormGestaoServidoresAlterarNota_ALTERAR_NOTA.Text;
        ...
        private void FORM_GERIR_SERVIDORES_ALTERARSERVIDOR_ALTERARNOTA__KeyPress(object sender, KeyPressEventArgs e)
        {

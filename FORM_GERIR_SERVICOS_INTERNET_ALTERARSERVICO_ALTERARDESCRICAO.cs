...
{
    public partial class FORM_GERIR_SERVICOS_INTERNET_ALTERARSERVICO_ALTERARDESCRICAO : Form
    {
        ...
        public FORM_GERIR_SERVICOS_INTERNET_ALTERARSERVICO_ALTERARDESCRICAO()
        {
            InitializeComponent();
            ...
            TEXTBOX_GestaoServicosInternet_AlterarDescricao_ALTERARDESCRICAO.Text = FormGerirServicosInternet_Objects.AUX_Descricao;
        }

        private void MENUSTRIP_GestaoServicosInternet_AlterarDescricao_BUTTON_FECHAR_Click(object sender, EventArgs e)
        {
            this.Close();
        }

        private void BUTTON_GestaoServicosInternet_AlterarDescricao_GRAVAR_Click(object sender, EventArgs e)
        {
            if (REGEX_Texto_AdicionarDescricao() == true)
            {
                try
                {
                    FormGerirServicosInternet_Objects.AUX_Descricao = TEXTBOX_GestaoServicosInternet_AlterarDescricao_ALTERARDESCRICAO.Text;
        ...
        private void TEXTBOX_GestaoServicosInternet_AlterarDescricao_ALTERARDESCRICAO_TextChanged(object sender, EventArgs e)
        {
            if (TEXTBOX_GestaoServicosInternet_AlterarDescricao_ALTERARDESCRICAO.Text != "")
                BUTTON_GestaoServicosInternet_AlterarDescricao_GRAVAR.Enabled = true;
            
            if (TEXTBOX_GestaoServicosInternet_AlterarDescricao_ALTERARDESCRICAO.Text == "")
                BUTTON_GestaoServicosInternet_AlterarDescricao_GRAVAR.Enabled = false;
        }

        private void TEXTBOX_GestaoServicosInternet_AlterarDescricao_ALTERARDESCRICAO_KeyPress(object sender, KeyPressEventArgs e)
        {
...
//       ║..:    REGULAR EXPRESSIONS    :..║
        ...
        public bool REGEX_Texto_AdicionarDescricao()
        {
            ...
            string AdicionarDescricao = TEXTBOX_GestaoServicosInternet_AlterarDescricao_ALTERARDESCRICAO.Text;
